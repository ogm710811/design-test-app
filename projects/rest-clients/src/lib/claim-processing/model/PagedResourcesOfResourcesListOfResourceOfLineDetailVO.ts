...
import { ResourcesListOfResourceOfLineDetailVO } from './ResourcesListOfResourceOfLineDetailVO';

export interface PagedResourcesOfResourcesListOfResourceOfLineDetailVO {
    embedded?: ResourcesListOfResourceOfLineDetailVO;
