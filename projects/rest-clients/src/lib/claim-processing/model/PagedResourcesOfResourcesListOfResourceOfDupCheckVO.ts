...
import {ResourcesListOfResourceOfDupCheckVO} from './ResourcesListOfResourceOfDupCheckVO';

export interface PagedResourcesOfResourcesListOfResourceOfDupCheckVO {
  embedded?: ResourcesListOfResourceOfDupCheckVO;
