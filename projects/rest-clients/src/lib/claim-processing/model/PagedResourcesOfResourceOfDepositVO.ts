...
import {ResourcesListOfResourceOfDepositVO} from './ResourcesListOfResourceOfDepositVO';

export class PagedResourcesOfResourceOfDepositVO {
  _embedded?: ResourcesListOfResourceOfDepositVO;
