...
import {ResourcesListOfResourceOfClaimBillLineVO} from './ResourcesListOfResourceOfClaimBillLineVO';

export interface PagedResourcesOfResourceOfClaimBillLineVO {
  _embedded?: ResourcesListOfResourceOfClaimBillLineVO;
