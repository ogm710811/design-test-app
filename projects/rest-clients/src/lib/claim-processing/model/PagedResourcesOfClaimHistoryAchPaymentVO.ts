 ...
 */
import {ClaimHistoryAchPaymentVO} from './ClaimHistoryAchPaymentVO';
import {PageMetadataVO} from '../../PageMetadataVO';

export interface PagedResourcesOfClaimHistoryAchPaymentVO {
  _embedded?: ClaimHistoryAchPaymentVO;
