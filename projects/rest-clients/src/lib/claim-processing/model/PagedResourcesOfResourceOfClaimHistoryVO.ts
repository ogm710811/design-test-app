...
import {ResourcesListOfResourceOfClaimHistoryVO} from './ResourcesListOfResourceOfClaimHistoryVO';

export interface PagedResourcesOfResourceOfClaimHistoryVO {
  _embedded?: ResourcesListOfResourceOfClaimHistoryVO;
