 ...
 */
import {ResourceOfInsuredNoteVO} from './ResourceOfInsuredNoteVO';

export interface ResourcesListOfResourceOfInsuredNotesVO {
  items?: Array<ResourceOfInsuredNoteVO>;
}
