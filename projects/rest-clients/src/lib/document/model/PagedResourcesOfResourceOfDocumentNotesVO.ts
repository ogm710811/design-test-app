...
import {ResourceslistOfResourceOfDocumentNotesVO} from './ResourceslistOfResourceOfDocumentNotesVO';

export interface PagedResourcesOfResourceOfDocumentNotesVO {
  _embedded?: ResourceslistOfResourceOfDocumentNotesVO;
