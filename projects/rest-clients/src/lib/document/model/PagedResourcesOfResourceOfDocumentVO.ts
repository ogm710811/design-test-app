...
import {ResourceslistOfResourceOfDocumentVO} from './ResourceslistOfResourceOfDocumentVO';

export interface PagedResourcesOfResourceOfDocumentVO {
  _embedded?: ResourceslistOfResourceOfDocumentVO;
