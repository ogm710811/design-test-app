...
import {ResourcesListOfResourceOfUserRolesVO} from './ResourcesListOfResourceOfUserRolesVO';

export interface PagedResourcesOfResourceOfUserRolesVO {
  embedded?: ResourcesListOfResourceOfUserRolesVO;
