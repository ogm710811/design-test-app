...
import {ResourcesListOfLogonActivityVO} from './ResourcesListOfLogonActivityVO';

export interface PagedResourcesOfResourceOfLogonActivityVO {
  embedded?: ResourcesListOfLogonActivityVO;
