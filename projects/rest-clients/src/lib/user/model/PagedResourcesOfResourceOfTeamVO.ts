...
import {ResourcesListOfResourceOfTeamVO} from './ResourcesListOfResourceOfTeamVO';

export interface PagedResourcesOfResourceOfTeamVO {
  _embedded?: ResourcesListOfResourceOfTeamVO;
