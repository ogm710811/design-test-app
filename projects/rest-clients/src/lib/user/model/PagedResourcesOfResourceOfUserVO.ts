...
import {ResourcesListOfResourceOfUserVO} from './ResourcesListOfResourceOfUserVO';

export interface PagedResourcesOfResourceOfUserVO {
  _embedded?: ResourcesListOfResourceOfUserVO;
