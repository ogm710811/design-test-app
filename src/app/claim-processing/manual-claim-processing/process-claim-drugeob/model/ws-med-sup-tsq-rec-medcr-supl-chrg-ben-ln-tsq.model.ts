import {WsMedSupTsqRecMedcrSuplChrgBenLnChPpEntry} from './ws-med-sup-tsq-rec-medcr-supl-chrg-ben-ln-ch-pp-entry.model';

/**
 * Model class WsMedSupTsqRecMedcrSuplChrgBenLnTSQ
 * Path: screenbean/procclmdrugeobservice
 * Model: com::uhc::aarp::fox::domain::screenbean::procclmdrugeobservice::WsMedSupTsqRecMedcrSuplChrgBenLnTSQ
 * Legacy Mapping: WS-MED-SUPP-CHARGE-LINE
 */
export class WsMedSupTsqRecMedcrSuplChrgBenLnTSQ {
  medSuppScreenNum = 0;
  medSuppRendProvName = '';
  ...
  medSuppPriorPlan = '';
  medSuppPriorPlanInd = '';
  medSuppChPpEntrys: WsMedSupTsqRecMedcrSuplChrgBenLnChPpEntry[] = [];
}
