...
@Component({
  selector: 'fox-reactivate-claim',
  templateUrl: './reactive-claim-request.component.html',
  styleUrls: ['./reactive-claim-request.component.css']
})

export class ReactivateClaimRequestComponent implements OnInit, OnDestroy {
  ...
  denialRsn: string = '';
  pageTitle: string = 'Reactivate Claim Request';
