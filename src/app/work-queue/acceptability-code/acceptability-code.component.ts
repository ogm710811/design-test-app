...
@Component({
  selector: 'fox-acceptability-code',
  templateUrl: './acceptability-code.component.html',
  styleUrls: ['./acceptability-code.component.css']
})
export class AcceptabilityCodeComponent implements OnInit {
